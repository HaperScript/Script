...
-- Таблицы для динамической смены темы
local ThemeText = {}
local ThemeBg = {}
local ThemeBorder = {}
local ThemeStroke = {}
...
-- Добавляем обновление цвета активной вкладки при смене темы
table.insert(ToggleCallbacks, function()
    if activeTabBtn then
        activeTabBtn.TextColor3 = CFG.Accent
    end
end)
            ...
            if plr ~= LocalPlayer and plr.Character then
                ...
                if tHRP then
                    ...
                    if CFG.Tracers and tHum and tHum.Health > 0 and Drawing then
                        local screenPos, vis = Camera:WorldToViewportPoint(tHRP.P
